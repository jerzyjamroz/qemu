...
static DeviceState *ppce500_init_mpic(MachineState *machine, PPCE500Params *params,
...
void ppce500_init(MachineState *machine, PPCE500Params *params)
{
    ...
    object_property_add_child(qdev_get_machine(), "pci-host", OBJECT(dev), &error_abort);
...
void ccsr_core_write(void *opaque, hwaddr addr, uint64_t val, unsigned size)
{
    ...
    case 0x2e44: /* Memory Error disable */
        ...
        break;
    default:
        qemu_log_mask(LOG_GUEST_ERROR, "can't write undefined ccsr regster %x\n",
                      (unsigned)addr);
    }
}
...
static int e500_ccsr_initfn(SysBusDevice *dev)
{
    ...
    sysbus_mmio_map(dev, 0, ccsr->base);
    return 0;
}

static Property e500_ccsr_properties[] = {
    DEFINE_PROP_UINT32("base", PPCE500CCSRState, base, 0xff700000),
