...
int main(int argc, char *argv[])
{
    ...
    /* Repeat the set+get round trip test with 4 times spread over 1 day
     * to detect issues related to the local timezone.
     */
    ...
    /* This can be further verified by running with TZ= with each of:
     *  TZ=:UTC
     *  TZ=:America/New_York
     *  TZ=:Pacific/Honolulu
     *  TZ=:Asia/Calcutta
     * Run 'date' from a shell to see if TZ is being interpreted correctly.
     */
